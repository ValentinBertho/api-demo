 ...
 *       <sequence>
 *         <element name="doc" type="{http://schemas.datacontract.org/2004/07/S}DocVersion" minOccurs="0"/>
...
@XmlRootElement(name = "CreerDocVersion")
public class CreerDocVersion {

    @XmlElementRef(name = "doc", namespace = "http://mismo.fr/WSDocumentAth", type = JAXBElement.class, required = false)
    protected JAXBElement<DocVersion> doc;
     ...
     *     
     */
    public JAXBElement<DocVersion> getDoc() {
        return doc;
    }
     ...
     *     
     */
    public void setDoc(JAXBElement<DocVersion> value) {
        this.doc = value;
    }
