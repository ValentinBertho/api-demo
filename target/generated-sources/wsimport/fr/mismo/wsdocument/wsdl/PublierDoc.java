 ...
 *         <element name="fichier" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlRootElement(name = "PublierDoc")
public class PublierDoc {

    protected Integer idDocVersion;
    @XmlElementRef(name = "fichier", namespace = "http://mismo.fr/WSDocumentAth", type = JAXBElement.class, required = false)
    protected JAXBElement<String> fichier;
     ...
     *     
     */
    public JAXBElement<String> getFichier() {
        return fichier;
    }
     ...
     *     
     */
    public void setFichier(JAXBElement<String> value) {
        this.fichier = value;
    }
